            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-header-right">
                        <a href="/categories" class="btn btn-light">Back</a>
                    </div>
                </div>
                <div class="card-body">
                    ...
                    <form action="{{ url('/categories/update') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                                    ...
                                    <div class="col-lg-2">
                                        <div class="media">
                                            ...
                                            <div class="media-body text-right">
                                                <label class="switch">
                                                    <input name="status" value="1" type="checkbox" @if ($category->status) checked @endif><span class="switch-state"></span>
                                                </label>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-5 offset-md-1 shadow shadow-showcase">
                                <div class="card">
                                    <img src="{{ url($category->image_path) }}" style="width: 100%; height: auto;" alt="">
                                </div>
                            </div>
