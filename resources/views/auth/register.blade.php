                    ...
                    <div class="cont text-center s--signup">
                      ...
                      <div class="sub-cont">
                        ...
                        <div>
                            ...
                            <h6 class="text-center">Enter your Company Name,Email and Password For Signup</h6>
                            <div class="form-row">
                                <div class="col-md-12">
                                    <div class="form-group">

                                        <input id="name" type="text" placeholder="Company Name" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" required autocomplete="name" >
