    ...
    <div class="main-header-right">
      <div class="main-header-left">
        ...
        <div class="logo-wrapper">
            ...
            <a href="index.html">
                @if (!@empty(App\Models\User::company_logo(Auth::user()->id)))
                <img  width="110px" height="38px" src="{{  asset('company_image/'.App\Models\User::company_logo(Auth::user()->id))}}" alt="Image description">
                @else
                <img src="../assets/images/logo/compact-logo.png" alt="">
                @endif
      ...
      <div class="nav-right col pull-right right-menu">
        ...
        @else
          ...
          <li class="onhover-dropdown px-0"><span class="media user-header">
            @if (!@empty(App\Models\User::company_logo(Auth::user()->id)))
            <img class="mr-2 rounded-circle img-35" width="35px" height="35px" src="{{ asset('company_image/'.App\Models\User::company_logo(Auth::user()->id)) }}" alt="Image description">
            @else
            ...
            <ul class="profile-dropdown onhover-show-div">
              <li><i data-feather="user"> </i><a href="user-profile.html">{{ Auth::user()->name }}</a></li>
